  ...
  describe('[GraphQL - Code first]', () => {
    it('should generate appropriate files ', async () => {
      ...
      expect(files).toEqual([
        ...
        '/loader-0001/loader-0001.entity.ts',
        '/loader-0001/loader-0001.module.ts',
        '/loader-0001/loader-0001.repository.ts',
        '/loader-0001/loader-0001.resolver.ts',
        '/loader-0001/loader-0001.service.ts',
        '/loader-0001/loader-0001.resolver.spec.ts',
        '/loader-0001/loader-0001.service.spec.ts',
        '/loader-0001/mutation/create-loader-0001.input.ts',
        '/loader-0001/mutation/create-loader-0001.output.ts',
        '/loader-0001/mutation/remove-loader-0001.input.ts',
        '/loader-0001/mutation/remove-loader-0001.output.ts',
        '/loader-0001/mutation/update-loader-0001.input.ts',
        '/loader-0001/mutation/update-loader-0001.output.ts',
        '/loader-0001/query/loader-0001-by-id.type.ts',
        '/loader-0001/query/loader-0001-order.input.ts',
        '/loader-0001/query/loader-0001-page.args.ts',
        '/loader-0001/query/loader-0001-page.type.ts',
        '/loader-0001/query/loader-0001-where.input.ts',
      ]);
    });
  });
  describe('[GraphQL - Code first]', () => {
...
`);
    ...
    it('should generate "Domain0001" class', () => {
      expect(tree.readContent('/loader-0001/loader-0001.entity.ts'))
...
`);
    ...
    it('should generate "Domain0001Module" class', () => {
      expect(tree.readContent('/loader-0001/loader-0001.module.ts'))
        .toEqual(`import { Module } from '@nestjs/common';
import { TypeOrmModule } from '@nestjs/typeorm';

import { Domain0001 } from './loader-0001.entity';
import { Domain0001Repository } from './loader-0001.repository';
import { Domain0001Resolver } from './loader-0001.resolver';
import { Domain0001Service } from './loader-0001.service';
...
`);
    ...
    it('should generate "Domain0001Repository" class', () => {
      expect(tree.readContent('/loader-0001/loader-0001.repository.ts'))
...
`);
    ...
    it('should generate "Domain0001Resolver" class', () => {
      expect(tree.readContent('/loader-0001/loader-0001.resolver.ts'))
...
import { Domain0001Repository } from './loader-0001.repository';
import { Domain0001Service } from './loader-0001.service';
import { CreateDomain0001Input } from './mutation/create-loader-0001.input';
import { CreateDomain0001Output } from './mutation/create-loader-0001.output';
import { RemoveDomain0001Input } from './mutation/remove-loader-0001.input';
import { RemoveDomain0001Output } from './mutation/remove-loader-0001.output';
import { UpdateDomain0001Input } from './mutation/update-loader-0001.input';
import { UpdateDomain0001Output } from './mutation/update-loader-0001.output';
import { Domain0001PageArgs } from './query/loader-0001-page.args';
import { Domain0001Page } from './query/loader-0001-page.type';
...
`);
    ...
    it('should generate "Domain0001Service" class', () => {
      expect(tree.readContent('/loader-0001/loader-0001.service.ts'))
        .toEqual(`import { Injectable } from '@nestjs/common';
import { Transactional } from 'typeorm-transactional';
...
`);
    ...
    it('should generate "CreateDomain0001Input" class', () => {
      expect(
        tree.readContent('/loader-0001/mutation/create-loader-0001.input.ts'),
      ).toEqual(
...
`,
    ...
    it('should generate "CreateDomain0001Output" class', () => {
      expect(
        tree.readContent('/loader-0001/mutation/create-loader-0001.output.ts'),
      ).toEqual(
...
`,
    ...
    it('should generate "RemoveDomain0001Input" class', () => {
      expect(
        tree.readContent('/loader-0001/mutation/remove-loader-0001.input.ts'),
...
`);
    ...
    it('should generate "RemoveDomain0001Output" class', () => {
      expect(
        tree.readContent('/loader-0001/mutation/remove-loader-0001.output.ts'),
...
`);
    ...
    it('should generate "UpdateDomain0001Input" class', () => {
      expect(
        tree.readContent('/loader-0001/mutation/update-loader-0001.input.ts'),
      )
        .toEqual(`import { Field, ID, InputType, OmitType, PartialType } from '@nestjs/graphql';

import { CreateDomain0001Input } from './create-loader-0001.input';
...
`);
    ...
    it('should generate "UpdateDomain0001Output" class', () => {
      expect(
        tree.readContent('/loader-0001/mutation/update-loader-0001.output.ts'),
      ).toEqual(`import { Field, ObjectType } from '@nestjs/graphql';
...
`);
    ...
    it('should generate "Domain0001OrderInput" class', () => {
      expect(tree.readContent('/loader-0001/query/loader-0001-order.input.ts'))
...
`);
    ...
    it('should generate "Domain0001PageArgs" class', () => {
      expect(tree.readContent('/loader-0001/query/loader-0001-page.args.ts'))
...
import { Domain0001OrderInput } from './loader-0001-order.input';
import { Domain0001WhereInput } from './loader-0001-where.input';
...
`);
    ...
    it('should generate "Domain0001Page" class', () => {
      expect(tree.readContent('/loader-0001/query/loader-0001-page.type.ts'))
        .toEqual(`import { Field, ObjectType } from '@nestjs/graphql';
...
`);
    ...
    it('should generate "Domain0001WhereInput" class', () => {
      expect(tree.readContent('/loader-0001/query/loader-0001-where.input.ts'))
        .toEqual(`import { InputType, OmitType } from '@nestjs/graphql';
...
`);
  ...
  it('should create spec files with custom file suffix', async () => {
    ...
    const tree: UnitTestTree = await runner.runSchematic('loader', options);
    const files: string[] = tree.files;
